<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-06-30 04:59:34
         compiled from ".\smarty\templates\researchhome.html" */ ?>
<?php /*%%SmartyHeaderCode:588755922236dd7ce2-65633256%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '031e1e313df7b584eb981820b27bcaf720027cad' => 
    array (
      0 => '.\\smarty\\templates\\researchhome.html',
      1 => 1435640255,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '588755922236dd7ce2-65633256',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55922236e54d06_07466117',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55922236e54d06_07466117')) {function content_55922236e54d06_07466117($_smarty_tpl) {?><html>
<head>
	<meta charset="utf-8">
    <title>科研合作</title>
    <!--<link href="css/research_news.css" rel="stylesheet">-->  
    <link href="css/bootstrap.min.css" rel="stylesheet">
    <link href="css/common.css" rel="stylesheet">
    <link href="css/researchhome.css" rel="stylesheet">
...
>
    <?php echo '<script'; ?>
 src="js/researchhome.js"><?php echo '</script'; ?>
>
</head>
<body>
	<!--导航栏-->
    	...
    	<div class="con">
    		<div class="hor">
                <div class="rowlist1">
                    <!--小标题-->
                    <div class="tit01">
                        <div class="wz">&nbsp&nbsp&nbsp&nbsp院校合作</div>
                        <div class="more">
                            <a href="research/researchlist.html">more »</a>
                        </div>
                    </div>
    		...
    		<div class="hor">
                <div class="rowlist1">
                    <!--小标题-->
                    <div class="tit01">
                        <div class="wz">&nbsp&nbsp&nbsp&nbsp成果转让</div>
                        <div class="more">
                            <a href="#">more »</a>
                        </div>
                    </div>
    	...
    	<div class="con">
    		<div class="hor">
                <div class="rowlist1">
                    <!--小标题-->
                    <div class="tit01">
                        <div class="wz">&nbsp&nbsp&nbsp&nbsp企业合作</div>
                        <div class="more">
                            <a href="research/researchlist.html">more »</a>
                        </div>
                    </div>
    		...
    		<div class="hor">
                <div class="rowlist1">
                    <!--小标题-->
                    <div class="tit01">
                        <div class="wz">&nbsp&nbsp&nbsp&nbsp合作信息</div>
                        <div class="more">
                            <a href="#">more »</a>
                        </div>
                    </div><!--小标题-->
                    ...
                    <div class="row1">
                        <div id="scrollDiv" class="pub_news">
                            <ul>
                                <li><a href="#">这是公告标题的第1行这是公告标题的第1行</a></li>
                                <li><a href="#">这是公告标题的第2行这是公告标题的第2行</a></li>
                                <li><a href="#">这是公告标题的第1行这是公告标题的第3行</a></li>
                                <li><a href="#">这是公告标题的第1行这是公告标题的第4行</a></li>
                                <li><a href="#">这是公告标题的第1行这是公告标题的第5行</a></li>
                                <li><a href="#">这是公告标题的第1行这是公告标题的第6行</a></li>
